...
const EditarProducto = () => {
  ...
  useEffect(() => {
    if (codigo) {
      axios
        .get<Product[]>(`https://backendtdc.vercel.app/api/products/${codigo}`)
        .then((response) => {
  ...
  const handleSubmit = async (event: any) => {
    ...
    if (nombre.trim() === "" || nombre.length < 3) {
      ...
      Swal.fire(
        "Completa correctamente la descripción. Minimo 20 carácteres",
        "",
        "error"
      );
      return;
    ...
    axios
      .put(`https://backendtdc.vercel.app/api/products/${codigo}`, producto)
      .then(() => {
      ...
      .catch((error) => {
        ...
        alert(
          "Hubo un error al editar el producto. Consulta la consola para más detalles."
        );
      });
  };
    ...
    <>
      <div className="row my-4">
        <div className="text_nav text-center">
          <a className="tittle">Editar Producto a la Carta</a>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="form col-5 py-4">
          ...
          <div className="d-flex align-items-start">
            ...
            <textarea
              ...
              rows={5}
              onChange={handleChange}
              value={(producto as any).descripcion}
              name="descripcion"
              className="col-7 m-2 input_form"
            ></textarea>
          </div>
          ...
          >
            ...
            <option value="alimentos">Aliementos</option>

...
function EditInsumos() {
  ...
  useEffect(() => {
    if (codigo) {
      axios
        .get(`https://backendtdc.vercel.app/api/rawMaterial/${codigo}`)
        .then((response) => {
  ...
  const handleSubmit = async (event: any) => {
    ...
    axios
      .put(`https://backendtdc.vercel.app/api/rawMaterial/${codigo}`, producto)
      .then(() => {
  ...
  return (
    <>
      ...
      <div className="row justify-content-center">
        <img
          className={`${style.img_product} col-3`}
      ...
      <div className="row my-3 justify-content-center">
        <form className="form col-5 py-4" onSubmit={handleSubmit}>
          ...
          <input
            value={(producto as any).cantidad}
            name="cantidad"
            onChange={handleChange}
            type="number"
          ...
          <input
            ...
            onChange={handleChange}
            name="f_ingreso"
            value={formatApiDate((producto as any).f_ingreso)}
          ></input>
          ...
          <input
            ...
            onChange={handleChange}
            name="f_vencimiento"
            value={formatApiDate((producto as any).f_vencimiento)}
          ></input>

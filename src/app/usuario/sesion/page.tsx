            ...
            <div className="container-fluid" style={backgroundStyles}>
                <div className="row mt-5 ">
                    <div className={`${styles.form} col-3 text-center justify-content-center mt-5`}>
                        ...
                        <input type="password" className={`${styles.input_form} col-9 my-3 py-1 mx-2`} placeholder="Contraseña" onChange={e => setPassword(parseInt(e.target.value))}></input><br></br>

    ...
    return(
        ...
        <div className="container-fluid " style={backgroundStylesU}>
            ...
            <div className= "row m-3 p-0 text-center ">
                    <span className={`${styles.text_carta} mt-5 mb-3 fs-1`}>Bienvenidos a La Tienda del Café</span><br></br>
            ...
            <div className="row text-center justify-content-center my-5 mx-2 p-0">
                ...
                <div className={`${styles.form_car} col-4 mx-3`}>
                    ...
                    <span className={`${styles.text_form} px-5`}> Casa de la convencion </span><br />
                    <span className={`${styles.text_form} px-5`}> Rionegro </span>
                </div> 
                <div className={`${styles.form_car} col-4 mx-3`}>
                    <span className={`${styles.text_carta} `}>Contacto</span><br></br>
                    <span className={`${styles.text_form} px-5`}> Carlos Gonzaléz</span><br />
                    <span className={`${styles.text_form} px-5`}> Carlos@misena.edu.co</span>
                </div> 
            </div>   
        </div>
        </>
